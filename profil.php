...
$id_membre = $_SESSION['membre']['id_membre'] ;
$req = "
SELECT c.*, m.pseudo, m.prenom, m.nom, m.email, m.civilite, m.statut, m.date_enregistrement
FROM commande c 
...
while($commandes = $resultat -> fetch(PDO::FETCH_ASSOC)){ 
	...
	$contenu .= '<td><a href="?action=afficher&id_commande='. $commandes['id_commande'] .'" />Détail</a></td>';
...
<div class="profil">
	...
	<div class="profil_infos">
		<ul>
			...
			<li>Statut : <b><?php ($civilite == 'm') ? $var = 'Homme' :  $var = 'Femme'; echo $var ;  ?></b></li>
